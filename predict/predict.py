...
def execute(test_file_path):
    ...
    try:
        test_normal_loader = read(test_file_path)
    ...
    with torch.no_grad():
        ...
        data_df.to_csv(r"result/predict.csv", index=None)
        # print(m)
