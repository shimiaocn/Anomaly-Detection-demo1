...
def generate(train_file_path):
    ...
    """
            ...
            split the sequences into input and result format
...
def execute(train_file_path):
    ...
    try:
        seq_dataset = generate(train_file_path)
    except Exception:
