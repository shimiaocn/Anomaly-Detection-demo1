...
def func_session(log_file, p_file, window='session'):
    """
                Parameters
                ----------
                log_file : csv file
...
def func_sliding_window(log_file, p_file, window='session'):
    """
                Parameters
                ----------
                log_file : csv file
...
func_session(r"../Data/predict/Test", r"data\output.csv")
